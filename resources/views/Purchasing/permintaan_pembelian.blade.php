                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php 
                             ...
                             if ($rest == 0) {
                                 $no = "0001";
                                 $autonya = "$no/REQPP/$bulan/$tahun";
                             } else if ($rest < 9) {
                                 $no = $rest + 1;
                         
                                 $autonya = "000$no/REQPP/$bulan/$tahun";
                         
                             } else if ($rest < 99) {
                                 $no = $rest + 1;
                         
                                 $autonya = "00$no/REQPP/$bulan/$tahun";
                         
                             } else if ($rest < 999) {
                                 $no = $rest + 1;
                         
                                 $autonya = "0$no/REQPP/$bulan/$tahun";
                        ...
                        ?>
                        <form method="POST" action="{{url('/Purchasing/insert-pembelian')}}" class="form-horizontal" id="PermintaanPembelian_form">
                        {{csrf_field()}}
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">
                                        Periode</label>
                                    <div class="col-sm-7">
                                        <input class="form-control" type="text" name="periode" id="example1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">
...
function get_detail_barang() {
    ...
    var json = null;
    $.get('{{URL::to("Purchasing/get_detail_barang/")}}/' + id_barang, function(data) {
